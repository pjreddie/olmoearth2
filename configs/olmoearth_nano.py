"""OlmoEarth2 v1 — nano size (128-d, 4 enc / 4 dec). For local smoke tests."""
...
WANDB_PROJECT = "olmoearth2_v1_nano"
...
def run() -> None:
    ...
    main(
        ...
        model_config_builder=make_build_model_config("nano"),
        train_module_config_builder=build_train_module_config,
        dataset_config_builder=build_dataset_config,
        dataloader_config_builder=build_dataloader_config,
        trainer_config_builder=make_build_trainer_config(
            wandb_project=WANDB_PROJECT, wandb_enabled=False
        ),
