...
from olmoearth2.train.train_module.galileo import GalileoTrainModule
from olmoearth2.train.train_module.latent_mim import LatentMIMTrainModule
from olmoearth2.train.train_module.mae import MAETrainModule
