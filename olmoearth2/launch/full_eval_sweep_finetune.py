...
1. Finetune all eval tasks using TerraMind model (default lr only):
   python olmoearth2/internal/full_eval_sweep_finetune.py \
       --project_name test_finetune \
       --module_path olmoearth2/evals/models/terramind/terramind_launch.py \
       --cluster ai2/jupiter \
       --model terramind \
       --defaults_only
...
from olmoearth2.eval.models import get_launch_script_path
from olmoearth2.launch.all_evals import FT_EVAL_TASKS
from olmoearth2.launch.constants import EVAL_LAUNCH_PATH, EVAL_WANDB_PROJECT
