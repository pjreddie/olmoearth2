...
Example usage:
    python3 olmoearth2/internal/compute_h5_norm.py --h5py_dir /path/to/h5pydir  --supported_modalities "era5_10,landsat,naip_10,sentinel1,sentinel2_l2a,srtm,worldcover" --estimate_from 100 --output_path /weka/dfive-default/yawenz/helios/helios/data/norm_configs/computed_20250722.json
"""
...
from olmoearth2.data.utils import update_streaming_stats
