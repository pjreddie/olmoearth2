...
from olmoearth2.data.constants import ModalitySpec, TimeSpan
from olmoearth2.data.h5.utils import WindowMetadata, get_modality_dir
...
def get_modality_temp_meta_fname(
    ...
    This is created by the olmoearth2.dataset_construction.rslearn_to_olmoearth scripts. It will
